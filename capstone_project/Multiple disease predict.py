...
diabetes_model = pickle.load(open(r'C:\Users\user\Desktop\capstone_project\diabetes_model.sav','rb'))

heart_disease_model = pickle.load(open(r'C:\Users\user\Desktop\capstone_project\heart_disease_model.sav','rb'))

parkinsons_model = pickle.load(open(r'C:\Users\user\Desktop\capstone_project\parkinsons_model.sav','rb'))
